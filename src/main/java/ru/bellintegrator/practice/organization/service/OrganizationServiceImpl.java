...
public class OrganizationServiceImpl implements OrganizationService {
  ...
  @Override
  public List<OrganizationView> organizaton()  {
  ...
  public OrganizationView getOrganization(String id) throws ExceptionValid {
    validationId(id);
    return new OrganizationView(dao.loadById(new Long(id)));
  }

  @Override
  public List<OrganizationListView> getFilterOrg(String name,
                                                 String inn,
