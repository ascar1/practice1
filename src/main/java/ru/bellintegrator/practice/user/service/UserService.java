...
public interface UserService {
    ...
    List<UserListView> getFilter(Long office_id, String first_name, String second_name, String middle_name, String position, Long doc_Code, Integer citizenship_code) throws ExceptionValid;
